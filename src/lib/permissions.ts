...
// Registry lives in its own dependency-free module; re-exported here so the
// many existing importers of permissions.ts keep working unchanged.
export { MODULE_INFO, ALL_MODULES, type NavHub } from "./moduleInfo";
import { MODULE_INFO, ALL_MODULES, type NavHub } from "./moduleInfo";
