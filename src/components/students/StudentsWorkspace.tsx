...
/**
 * StudentsWorkspace — the school's student register: register, edit, search,
 * open a profile, and remove (transfer / expel).
 *
 * This is the Principal's screen, lifted out of /principal/students so the
 * staff portal can render exactly the same thing. A teacher or admin staffer
 * granted management of the STUDENTS module gets this, not a read-only copy
 * that drifts out of step with it.
 *
 * `basePath` decides where a student profile link points; `contextLinks` is
 * the tab strip, which differs between portals because the staff portal files
 * staff under /staff/directory rather than /staff/staff.
 */
