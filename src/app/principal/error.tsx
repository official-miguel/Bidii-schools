...
/**
 * error.tsx — Principal portal error boundary
 *
 * Catches any unhandled error within the /principal route segment.
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="mb-2 text-2xl font-bold text-foreground">
        Something went wrong — Principal portal
      </h1>

      <p className="mb-8 max-w-sm text-sm leading-relaxed text-slate">
        An unexpected error occurred in the principal portal. You can try again
