  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        ...
        {/* Detail grid */}
        <dl className="grid grid-cols-1 sm:grid-cols-2 gap-0 divide-y divide-border sm:divide-y-0 sm:divide-x">
          {[
          ...
          {record.description && (
            <div className="px-5 py-4 sm:col-span-2 border-t border-border">
