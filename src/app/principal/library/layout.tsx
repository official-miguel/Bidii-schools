...
/**
 * Module gate for the Library section.
 *
 * Library is one of the three optional modules a super admin can switch off
 ...
 */
export default async function PrincipalLibraryLayout({ children }: { children: React.ReactNode }) {
