  ...
  return (
    <div>
      <div className="flex items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-xl font-bold text-foreground">Book Analytics</h1>
            ...
            <Section title="Most Borrowed (Ranked)"
              ...
              <div className="rounded-xl border border-border bg-card overflow-hidden">
                {data.books.popular.map((b, i) => (
                  <div key={b.id} className="flex items-center gap-3 px-4 py-3 border-b border-border last:border-0 hover:bg-slate-50/40">
                    ...
                    <span className="text-sm font-bold text-foreground">{b.borrowCount}</span>
                  </div>
                ))}
              </div>
            </Section>
            ...
            <div className="rounded-xl border border-border bg-card overflow-hidden">
              {data.books.leastUsed.slice(0, 15).map((b, i) => (
                <div key={b.id} className="flex items-center gap-3 px-4 py-3 border-b border-border last:border-0 hover:bg-slate-50/40">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link href={`/staff/library/inventory/${b.id}`} className="text-sm font-medium text-foreground hover:text-teal truncate block">{b.title}</Link>
