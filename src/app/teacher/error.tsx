...
/**
 * error.tsx — Teacher portal error boundary
 *
 * Catches any unhandled error within the /teacher route segment.
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="mb-2 text-2xl font-bold text-ink dark:text-dark-text">
        Something went wrong — Teacher portal
      </h1>

      <p className="mb-8 max-w-sm text-sm leading-relaxed text-slate">
        An unexpected error occurred in the teacher portal. You can try again
