...
/**
 * error.tsx — Super-admin portal error boundary
 *
 * Catches any unhandled error within the /super-admin route segment.
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="mb-2 text-2xl font-bold text-foreground">
        Something went wrong — Super-admin portal
      </h1>

      <p className="mb-8 max-w-sm text-sm leading-relaxed text-slate">
        An unexpected error occurred in the super-admin portal. You can try
